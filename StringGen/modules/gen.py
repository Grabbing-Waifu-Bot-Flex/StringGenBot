...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("Grabbing_Your_WH_Group"))
        else:
            ...
            await client.join_chat("Grabbing_Your_WH_Group")
    except KeyError:
        pass
    try:
